...
const profile: ProfileData = {
  ...
  projects: [
    ...
    {
      name: "NexBuy – Microservices E-Commerce Platform",
      description: "Designed and developed a scalable microservices-based e-commerce application using Spring Boot and Spring Cloud.Implemented independent microservices including Product Service, User Service, Order Service, Inventory Service, API Gateway, Service Discovery (Eureka), and Config Server.Secured REST APIs using Spring Security and JWT Authentication & Authorization.Configured Docker containers for all microservices and created Docker Compose for local deployment.",
      technologies: ["API Gateway","Eureka Server","Docker","Kubernetes","Spring Security","Spring Cloud Gateway","Feign Client","Resilience4j","RabbitMQ / Kafka"],
      link: "https://github.com/Nikhil-Singh-Rajpoot/devops_nex_buy",
    },
    {
  ...
  achievements: [
    ...
    {
      title: "State University Gold Medalist (MCA)",
      issuer: "University India",
      date: "2025",
      description: "Awarded the State University Gold Medal for securing the highest academic performance in the MCA program"
    },
    {
